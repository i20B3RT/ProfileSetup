package com.uscold.ProfileSetup.test;
...
import com.uscold.ProfileSetup.test.utility.TestConstants;
import com.uscold.ProfileSetup.test.utility.WebDriverFactory;
...
import static com.uscold.ProfileSetup.test.utility.TestConstants.GET_ELEMENT_TIMEOUT;
...
//        driver.get(EWM_URL.substring(1,34)+"labelling/loadLabelMappingView");
